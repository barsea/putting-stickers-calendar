    ...
    <div className="p-4 bg-gray-50 border-t">
      ...
      <div className="grid grid-cols-2 gap-3">
        {stickerTypes.map((stickerType) => {
          ...
          return (
            <div key={stickerType} className="flex items-center gap-2">
              <div className={`w-4 h-4 ${colorClasses.bg} rounded-full flex-shrink-0`}></div>
              ...
              {isEditing ? (
                <input
                  ...
                  maxLength={20}
                  className="flex-1 px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:border-blue-400 bg-white"
                  placeholder="ラベルを入力..."
                  autoFocus
                />
              ) : (
                <button
                  ...
                  className={`flex-1 text-left px-2 py-1 text-sm ${colorClasses.text} ${colorClasses.hover} rounded transition-colors`}
                >
